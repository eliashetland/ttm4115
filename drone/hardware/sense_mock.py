...
class SenseMock(SenseInterface):
    ...
    def on_connect(self, client, userdata, flags, rc):
        ...
        # CHANGED: drones -> mock
        self.topic_handlers = {
            f"mock/{id}/joystick/add": self._mqtt_add_joystick_event,
            f"mock/{id}/sense/pixel/get": self._mqtt_get_pixel,
        }
    ...
    def _mqtt_get_pixel(self, payload):
        ...
        # CHANGED: drones -> mock
        self.client.publish(
            f"mock/{self.drone_id}/sense/pixel/state",
            json.dumps(data)
        )
